...
export const getGenresContentsAPI = (genre, date) => {
    return fetch(
        `${API_HOST}/discover/movie?with_genres=${genre.id}&primary_release_year=${date.getFullYear()}&api_key=${APP_KEY}&language=ko-KR`,
        {
            method:"GET",
            headers:{
                "Content-Type": "application/json"
